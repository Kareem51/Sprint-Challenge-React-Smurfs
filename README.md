...
Server-side routing results in a full refresh of the page its loading up
Client-side routing only refreshes the JS thats already loaded on the page 
...
GET: Read, PUT: Update, PATCH: modify, DELETE: Delete
